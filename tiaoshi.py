...
get_metrics(prediction_dir=os.path.join('Resultsdosediff4/ddim8_TTA1_Timealltest_setp', 'prediction'),
            gt_dir=r'D:\medical_image\code\dose_prediction\myself\First\data/hutest/alltest',
            save_dir=r'Resultsdosediff4/ddim8_TTA1_Timealltest_setp',
